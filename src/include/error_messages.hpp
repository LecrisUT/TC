...
void compare_list(const std::string &keyword, const std::string &input,
                  const std::vector<std::string> &list);

// Print an error message: an inappropriate argument is specified for "keyword",
// and stop the program
//   optional: "condition" is also displayed if condition!=""
void inappropriate_argument(const std::string &keyword,
                            const std::string &input,
                            const std::string &condition);
void inappropriate_argument(const std::string &keyword, const int &input,
                            const std::string &condition);

// Print an error message: "what" (keyword) is not found in "where" (file name),
// and stop the program
