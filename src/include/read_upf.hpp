...
void read_upf(FileNames &file_names, CrystalStructure &crystal_structure,
              Potentials &potentials, PlaneWaveBasis &plane_wave_basis,
...
void read_upf_header(std::ifstream &ifs, const std::string &file_name_upf,
                     const bool is_upf_ver2, double &Z_valence, int &mesh_size,
                     int &num_projectors, std::ostream *ost);
...
void read_upf_nonlocal(std::ifstream &ifs, const bool is_upf_ver2,
                       ...
                       Eigen::MatrixXd &pseudo_dij, std::ostream *ost);
